...
function sum(a, b) { //eslint-disable-line
  let sumTotal = a + b;
  let str = `The sum of ${a} and ${b} is ${sumTotal}.`;
  //console.log([sum, str])
...
/////////////////////////////////////
/* Problem 2
Write a function called multiply() that takes in two numbers as arguments and returns an array where the first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the funcode action:
...
function sumArray(sumArr) { //eslint-disable-line
  let grandTotal = sum(testArray[0] ,testArray[1])[0];
  let gTSum = sum(testArray[2], grandTotal)[0];
  let arrStr = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${[gTSum]} is their sum.`;
